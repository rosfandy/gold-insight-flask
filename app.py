...
def predict():
    ...
    # Create the plot
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=predictions_df.index, y=predictions_df['Gold price'], mode='lines', name='Gold Price'))
    fig.update_layout(title='Predicted Gold Price', xaxis_title='Date', yaxis_title='Gold Price')
